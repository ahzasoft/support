...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
            <a href="/actions" class="nav-link">{{Request::route()->getName()}}</a>
        </li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="image" style="padding-bottom: 30px">
                                    <img src="{{asset('assets/dist/img/user.png')}}" class="img-circle elevation-2" alt="User Image" style="margin: auto">
                                </div>
                            </div>
                        </div>
                        <div class="row">
